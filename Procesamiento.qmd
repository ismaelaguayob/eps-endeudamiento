...
-   Unir las bases de datos de 2020 y 2024

-   Calcular el rci_dt de cada folio (individuo)

-   Ver relación bivariada entre EGP y rci_dt en la muestra completa

-   Realizar un par de gráficos

### Temas a conversar

-   Cómo tratar ciuo8: nos quedamos con la última pega de la historia laboral

-   Qué variables utilizamos para construir el rci

-   Qué variables control agregamos
